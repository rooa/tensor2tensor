...
def aggregate_stats(stats_files):
  ...
  agg_stats = dict(
      ...
      per_wiki_ref_coverage_dist=list(map(int, list((coverage_dist * 100)))),
      per_wiki_ref_coverage_bounds=list(map(int, list((coverage_bounds * 100)))),
      ref_len_dist=list(map(int, list((len_dist * 100)))),
